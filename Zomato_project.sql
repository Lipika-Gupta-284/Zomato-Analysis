...
--*/9. If buying each product for eg 5 rs -2 zomato points and each product has different 
purchase points eg for p1 10 rs - 5 zomato points , for p2 5 rs - 1 zomato points,
for p3 5 rs - 1 zomato points\*
...
--10. In the first one year after a customer joins the gold program(including their join date rate)
irrespective of what the customer has purchased they earn 5 zomato points for every 10 rs spent who 
earned more 1 or 3 and what was the their points earnings in their first year?
